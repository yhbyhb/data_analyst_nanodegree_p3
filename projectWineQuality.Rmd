...
'quality' variable is just numerical value. So, I converted it to 6 levels factored variable named 'quality_class' for categorical analysis.
...
First, I will look into scatterplots involving quality and some other features, such as alcohol, sulphates, volatile.acidity and so on.
...
I used factored variable 'quality_class' for boxplot. The boxplot shows the trend of median alcohol value of each quality.
...
The linear model of alcohol and quality has R^2 value 0.2314. 'wineSubset' is removed alcohol outlier above 99.9%.
