...
```{r echo=FALSE, citric.acid_and_quality}
...
p1 <- ggplot(aes(x = quality_class, y = residual.sugar), data = wineQuality)  +
  geom_boxplot() +
...
p2 <- ggplot(aes(x = quality_class, y = chlorides), data = wineQuality)  +
  geom_boxplot() +
...
p3 <- ggplot(aes(x = quality_class, y = citric.acid), data = wineQuality) +
  geom_boxplot() +
