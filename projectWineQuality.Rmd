...
ggplot(aes(x = alcohol, y = density), data = wineQuality) +
  geom_jitter(aes(color=quality_class, bg=quality_class), alpha = 1/4, pch=21, cex=3) +
...
A limitation of this analysis is that the data set are sampled from the Portuguese "Vinho Verde" red wine. It might be interesting to obtain data set from various regions to eliminate any bias created by various products.