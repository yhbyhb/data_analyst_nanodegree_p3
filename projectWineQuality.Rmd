...
A limitation of this analysis is that the data set sampled from the Portuguese "Vinho Verde" red wine. It might be interesting to obtain data set from various regions to eliminate any bias created by various products.