...
qplot(x = residual.sugar, y = quality, data = wine_chlorides_subset,
      color = I('black'), alpha = I(1/5)) +
  geom_smooth(method = 'lm', se = T, color = 'blue')
...
I want to check relationship among similar variables.
...
I think the taste of wine is mostly affected by acidity and alcohol. I check pH and alcohol.

```{r echo=FALSE, alcohol_pH_and_quality}
ggplot(aes(x = alcohol, y = pH), 
       data = wineQuality) +
  geom_jitter(aes(color=quality_class, bg=quality_class), 
              alpha = 1/2, pch=21, cex=2)
...
Alcohol and pH has positive correlation. Lowest quality(3) and highest quality(8) are distributed 
