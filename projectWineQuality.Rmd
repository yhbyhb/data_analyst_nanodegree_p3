...
```{r, echo=FALSE}
pairs.panels(wineQuality)
```

```{r echo=FALSE, quality and alcohol}
qplot(y = alcohol, x = quality, data = wineQuality)
```

```{r, echo=FALSE, quality and density}
